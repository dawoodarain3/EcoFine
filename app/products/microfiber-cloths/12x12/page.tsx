...
export default function MicrofiberCloth12x12Page() {
  ...
  const [selectedImage, setSelectedImage] = useState("/placeholder.svg?height=600&width=600")
  ...
  const colorImages = {
    ...
    Green: "/placeholder.svg?height=600&width=600&text=Green",
    Yellow: "/placeholder.svg?height=600&width=600&text=Yellow",
    Red: "/placeholder.svg?height=600&width=600&text=Red",
    Purple: "/placeholder.svg?height=600&width=600&text=Purple",
    Pink: "/placeholder.svg?height=600&width=600&text=Pink",
    Orange: "/placeholder.svg?height=600&width=600&text=Orange",
    Black: "/placeholder.svg?height=600&width=600&text=Black",
    White: "/placeholder.svg?height=600&width=600&text=White",
    Gray: "/placeholder.svg?height=600&width=600&text=Gray",
    "Dark Royal Blue": "/placeholder.svg?height=600&width=600&text=Dark+Royal+Blue",
    Brown: "/placeholder.svg?height=600&width=600&text=Brown",
    "Blue/Green/Yellow/Red Pack": "/placeholder.svg?height=600&width=600&text=Color+Pack+1",
    "Black/Grey Pack": "/placeholder.svg?height=600&width=600&text=Color+Pack+2",
  }
        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-8 md:grid-cols-2">
              ...
              <div className="grid grid-cols-4 gap-2">
                {[...Array(4)].map((_, i) => (
                  <div
                    ...
                    onClick={() => setSelectedImage(`/placeholder.svg?height=150&width=150&text=View+${i + 1}`)}
                  >
                    <Image
                      src={`/placeholder.svg?height=150&width=150&text=View+${i + 1}`}
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-3xl font-bold mb-2">EcoFine Microfiber Cloth - 12" x 12"</h1>
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="border rounded-lg overflow-hidden">
                <Link href="/products/microfiber-cloths/16x16">
                  <Image
                    src={bluemain}
